...
``` {.bash .prefixed}
sudo jupyter kernelspec install /opt/conda/envs/c-cpp/share/jupyter/xcpp11 --sys-prefix
```

``` {.bash .prefixed}
sudo jupyter kernelspec install /opt/conda/envs/c-cpp/share/jupyter/xcpp14 --sys-prefix
```

``` {.bash .prefixed}
sudo jupyter kernelspec install /opt/conda/envs/c-cpp/share/jupyter/xcpp17 --sys-prefix
```
...
``` {.bash .prefixed}
ls -al /opt/conda/envs/c-cpp/share/jupyter/c
```
