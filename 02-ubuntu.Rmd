...
```
    ...
    Aug 15 16:08:54 fintech06 systemd[1]: Starting OpenBSD Secure Shell server...
    Aug 15 16:08:55 fintech06 sshd[893]: Server listening on 0.0.0.0 port 60000.
    Aug 15 16:08:55 fintech06 sshd[893]: Server listening on :: port 60000.
    Aug 15 16:08:55 fintech06 systemd[1]: Started OpenBSD Secure Shell server.

重新測試 ssh 遠端連線至伺服器，

``` {.bash}
ssh -p 60000 fintech@192.168.0.13
```
